...
class Profile(UserMixin, db.Model):
    ...
    profile_id = db.Column(db.Integer, autoincrement=True, nullable=False,
                           primary_key=True)
...
class Musician(db.Model):
    ...
    musician_id = db.Column(db.Integer, autoincrement=True, nullable=False,
                            primary_key=True)
...
class Venue(db.Model):
    __tablename__ = 'Venue'
    venue_id = db.Column(db.Integer, autoincrement=True, nullable=False,
                         primary_key=True)
    ...
    def __repr__(self):
        return '<Venue Capacity:{}, Venue Type: {}>'.format(
            self.venue_capacity, self.venue_type)


class Genre(db.Model):
    __tablename__ = 'Genre'
    genre_id = db.Column(db.Integer, autoincrement=True, nullable=False,
                         primary_key=True)
    genre_name = db.Column(db.Text)

    def __repr__(self):
        return '<Genre ID:{}, Genre Name: {}>'.format(self.genre_id,
                                                      self.genre_name)


class Media(db.Model):
    __tablename__ = 'Media'
    media_id = db.Column(db.Integer, autoincrement=True, nullable=False,
                         primary_key=True)
...
class Profile_Rate(db.Model):
    ...
    rating_id = db.Column(db.Integer, autoincrement=True, nullable=False,
                          primary_key=True)
    profile_id = db.Column(db.Integer, db.ForeignKey(Profile.profile_id),
                           nullable=False)
