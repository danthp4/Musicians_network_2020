...
from wtforms import SubmitField, StringField, SelectField, TextAreaField, SelectMultipleField, PasswordField, DateField, IntegerField
...
class MusicianForm(FlaskForm):
    ...
    availability = SelectField(u'Availability', choices=[('1','Available'),('0','Unavailable')], validators=[DataRequired()])
